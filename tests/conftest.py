...
# ruff: noqa: E402
from core.db import build_name_index as _build_name_index
from core.db import get_collection as _get_collection
from core.embeddings import _embedding_model_ready
from core.embeddings import get_model as _get_model
